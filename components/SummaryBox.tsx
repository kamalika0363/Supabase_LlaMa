...
const SummaryBox: React.FC = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-[#161617] to-[#212020] p-6 rounded-xl flex flex-col item-center justify-center h-full w-2/5 border-2 border-[#272728] ">
      <div className="bg-[#1c1b1c] p-5 rounded-xl item-center justify-center w-full h-96 border-2 border-[#3a3a3a]">
        <p className="text-gray-300 mb-2 justify-center font-bold text-lg">Summarize Data</p>
      ...
      <form onSubmit={handleAddLink} className="mt-20 rounded-lg flex space-x-4">
        ...
        />
        <button type="submit" className=" text-white rounded-xl p-2 border-2 border-[#3a3a3a] bg-[#272728]">
