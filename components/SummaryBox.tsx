...
const SummaryBox: React.FC = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-[#161617] to-[#212020] sm:p-6 rounded-xl flex flex-col item-center justify-center md:h-full h-96 md:w-2/5 border-2 border-[#272728] overflow-auto p-6">
      <div className="bg-[#1c1b1c] p-5 sm:mt-0 mt-16 rounded-xl item-center justify-center w-full h-96 border-2 border-[#3a3a3a]">
