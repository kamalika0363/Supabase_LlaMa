...
const SummaryBox: React.FC = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-[#161617] to-[#212020] p-6 rounded-xl flex flex-col item-center justify-center md:h-1/3 h-96 md:w-2/5 border-2 border-[#272728] ">
